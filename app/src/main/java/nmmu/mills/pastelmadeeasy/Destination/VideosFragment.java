...
public class VideosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.videos_fragment_recycler);
    ...
    private void fillList() {
        ...
        while (res.moveToNext()){
            String actionStatement = "watch video...";
            String extra = "";
            boolean complete = false;
            if (myDB.getComplete(res.getInt(0),"conceptVideoWatched")) {
                extra = "Seen";
                complete = true;
            }
            else
